# CMP9137 Advanced Software Engineering
This repository houses the devcontainer and docker image for the CMP9137 Advanced Software Engineering module at the University of Lincoln.
## What is Docker?
...
3. Inside the extracted folder is a folder entitled 'CMP9137 Advanced Software Engineering' which contains the .devcontainer folder. Move 'CMP9137 Advanced Software Engineering' to wherever you like, this will be your working directory for this module.
4. Make sure Docker Desktop is running. You can minimise the window.
5. Open VS Code, go to File -> Open Folder, and select your 'CMP9137 Advanced Software Engineering' folder.
